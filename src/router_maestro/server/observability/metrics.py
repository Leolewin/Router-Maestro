...
STANDARD_HTTP_METHODS = frozenset(
    {
        "GET",
        "POST",
        "PUT",
...
def normalize_http_method(method: str) -> str:
    """Return a low-cardinality HTTP method label."""
    normalized = method.upper()
    return normalized if normalized in STANDARD_HTTP_METHODS else OTHER_HTTP_METHOD
